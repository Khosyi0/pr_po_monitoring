...
"""
            ...
            try:
                ...
                with pd.ExcelWriter(excel_buffer, engine='xlsxwriter') as writer:
                    df_export.to_excel(writer, sheet_name='Ringkasan Ammonia', startrow=5, header=False)
                    
                    workbook  = writer.book
                    worksheet = writer.sheets['Ringkasan Ammonia']
                    ...
                    worksheet.write('A1', f'Laporan Komparasi Tren Harga Ammonia ({jenis_harga})', title_format)
                ...
                st.download_button(
                    ...
                    file_name=f"Laporan_Tren_Harga_Ammonia_{jenis_harga}.xlsx",
                    mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                    key="download_excel_ammonia"
                )
